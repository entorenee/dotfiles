...
let
  ...
  workConfig = "${config.home.homeDirectory}/dotfiles/nix/modules/gh-dash/config/work-config.yml";
  starterConfig = "${config.home.homeDirectory}/dotfiles/nix/modules/gh-dash/config/starter-config.yml";
