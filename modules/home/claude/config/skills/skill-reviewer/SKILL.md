...
Name the skill under review. Read `$MY_AGENT_ARTIFACTS_ROOT/skill-reviewer/LEDGER.md`; if it has a previous entry for this skill, that row is the baseline and this review must report the delta against it. If not, this review *is* the baseline — say so, and do not imply a trend from a single measurement.
